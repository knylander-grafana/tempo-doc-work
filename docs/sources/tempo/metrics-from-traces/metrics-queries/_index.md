...
You can also combine metrics queries and scalar operands with arithmetic operators (`+`, `-`, `*`, `/`) to compute derived metrics, for example, error rate ratios and percentages.
